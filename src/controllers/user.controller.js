...
const generateAccessAndRefreshToken = async (userId)=>{
    try {
        ...
        throw new ApiError(500, "Something went wrong: RefreshToken and AccessToken not generated")
    }
}
const registerUser = asyncHandler( async (req, res) =>{
    ...
    // check for userCreation and return res
...
const logOutUser = asyncHandler( async (req, res) =>{
    await User.findByIdAndUpdate(
        ...
        {
            $unset : {
                refreshToken: 1 // this removes the refresh token from document
            }
        },
        {
            new : true
...
const refreshAccessToken = asyncHandler( async (req, res) =>{
    ...
    try {
        ...
        throw new ApiError(401, error.message?.message || "Invalid Refresh Token")
    }
})
